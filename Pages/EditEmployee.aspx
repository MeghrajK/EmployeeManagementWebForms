<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditEmployee.aspx.cs" Inherits="EmployeeManagementWebForms.Pages.EditEmployee" %>--%>

<%--<%@ Page Title="Edit Employee" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="EditEmployee.aspx.cs" Inherits="EditEmployee" %>--%>
<%@ Page Title="Edit Employee" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="EditEmployee.aspx.cs" Inherits="EmployeeManagementWebForms.Pages.EditEmployee" %>
        ...
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <asp:Button ID="btnUpdate" runat="server" Text="Update Employee" CssClass="btn btn-primary" OnClick="btnUpdate_Click" />
